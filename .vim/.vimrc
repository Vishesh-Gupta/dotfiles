...
" The NERDTree vim script is for file system for the Vim editor
Plugin 'scrooloose/nerdtree'

" The cpp enhanced highlight package
Plugin 'octol/vim-cpp-enhanced-highlight'

" The vim color schemes package
Plugin 'flazz/vim-colorschemes'


" The surround.vim plugin for surroundings
Plugin 'tpope/vim-surround'

" The vim wakatime plugin for automatic metric generation and tracking
...
" Fuzzy pathfinding plugin
Plugin 'kien/ctrlp.vim'

" Plugin for autocompletion
Plugin 'ajh17/vimcompletesme'

" Plugin for man pages in vim
Plugin 'vim-utils/vim-man'

" Plugin for undo tree
